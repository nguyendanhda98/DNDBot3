...
console.log(gameTableManagement.getGameTable(host).join(user2))
gameTableManagement.addPlayerInTable(user2, host)
///////////////////////////////////////

const gameTable = gameTableManagement.getGameTable(host)

gameTableManagement.removeTable(host)
...
console.log(gameTable.players.length)

console.log(gameTableManagement.playersInTable)

// console.log(gameTableManagement.getGameTable(host).ready(host))
