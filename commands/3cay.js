    ...
    switch (args[0]) {
            ...
            addFields: [
              ...
              },
              {
                ...
                value: result.players
                  .map((player) => `${player.username} (${player.betAmount})`)
                  .join('\n'),
              },
            ],
          };
      ...
      case 'bet': // bet <So tien>
        ...
        if (+args[1] > profileData.cash) {
          extra = {
            setDescription: 'Số DND của bạn không đủ!',
          };
          break;
        }
      ...
      case 'start':
        ...
        if (totalBetAmount > profileData.cash) {
          extra = {
            setDescription: 'Số DND trong ví của nhà cái không đủ!',
          };
          break;
        }
      ...
      case 'check':
        ...
        console.log('playersInTable', gameTableManagement.playersInTable);
        ...
        if (amount % 1 != 0 || amount <= 0) {
            ...
            addFields: [
              {
                ...
                value: `${playerCards[1].getShowCards(0).join(' ')}`,
                inline: true,
              },
              {
          ...
          const getEditEmbed = (numberCard) => {
            extra.addFields = [
              {
                name: playerCards[1].username,
                value: `${playerCards[1].getShowCards(numberCard).join(' ')}`,
                inline: true,
              },
              {
                name: playerCards[0].username,
